...
object TestData {
  ...
  val updatedProduct1 = List(Map("id" -> 1.0, "name" -> "Mac Book Retina 15'", "price" -> 1299.0, "quantity" -> 2.0))

  val updatedProduct2 = List(Map("id" -> 1.0, "name" -> "Mac Book Retina 15'", "price" -> 1299.0, "quantity" -> 10.0))
}
